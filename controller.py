...
class PoltergustController:
    ...
    def __init__(self, view: PoltergustMainView, db: MK8CTStorage):
        ...
        self.view.menu_edit.entryconfig(self.view.BTN_CHANGE_TRACK, command=lambda: PoltergustChangeTrackView(self.view.root, 32, self.view.TRACK_MAPPER, current_mod=next(self.db.get_mods())))
